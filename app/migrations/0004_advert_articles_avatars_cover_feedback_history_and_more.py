...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('app', '0003_remove_userinfo_height_remove_userinfo_score_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='userinfo',
            name='integral',
            field=models.IntegerField(default=20, verbose_name='用户积分'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='is_active',
        ...
        migrations.AddField(
            model_name='userinfo',
            name='nick_name',
            field=models.CharField(blank=True, max_length=16, null=True, verbose_name='昵称'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='nid',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addr', models.JSONField(null=True, verbose_name='用户地址信息')),
                ('create_date', models.DateTimeField(auto_now=True, verbose_name='发布时间')),
                ('content', models.TextField(verbose_name='心情内容')),
                ('drawing', models.TextField(blank=True, null=True, verbose_name='配图组，以;隔开')),
                ('comment_count', models.IntegerField(default=0, verbose_name='评论数')),
                ('digg_count', models.IntegerField(default=0, verbose_name='点赞数')),
                ('avatar', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.avatars', verbose_name='心情的发布头像')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.avatars', verbose_name='心情的发布头像')),
                ('mood', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.moods', verbose_name='评论的心情')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='articles',
            name='cover',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.cover', verbose_name='文章封面'),
        ),
        migrations.AddField(
            model_name='articles',
            name='tag',
            field=models.ManyToManyField(blank=True, to='app.tags', verbose_name='文章标签'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='avatar',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.avatars', verbose_name='用户头像'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='collects',
            field=models.ManyToManyField(blank=True, to='app.articles', verbose_name='收藏的文章'),
        ),
    ]
